...
const Appointments = () => {
  ...
  const handleSubmit = (e) => {
    ...
    toast.success(
      `${formData.student === "stu1" ? "Jane Doe" : formData.student === "stu2" ? "Michael Smith" : "Lily Willaim"} accepted your appointment request`,
      { autoClose: 3000 }
    );
  ...
  const startCall = () => {
    ...
    setTimeout(() => {
      toast.warning(`🚪 ${formData.student === "stu1" ? "Jane Doe" : formData.student === "stu2" ? "Michael Smith" : "Lily Willaim"} has left the call`, {
        autoClose: 3000,
      });
      setCallIncoming(false);
      setScadOnline(false);
      ...
      <main className="appointments-main">
        ...
        {appointmentConfirmed && !callIncoming && (
          <div className="confirmation-banner">
            ✅ Your appointment request with <strong>
        ...
        {appointmentAccepted && !callIncoming && (
          <div className="confirmation-banner">
            <p>🟢 {formData.student === "stu1" ? "Jane Doe" : formData.student === "stu2" ? "Michael Smith" : "Lily Willaim"} is online and ready for the call.</p>
            <div className="confirmation-actions">
          ...
          <div className="call-container">
            <div className="call-header">
              <h3 className="call-status">
                📞 {isConnecting ? "Connecting..." : `In Call with ${formData.student === "stu1" ? "Jane Doe" : formData.student === "stu2" ? "Michael Smith" : "Lily Willaim"}`}
              </h3>
              <p className="call-description">
                {scadOnline
                  ? `🟢 ${formData.student === "stu1" ? "Jane Doe" : formData.student === "stu2" ? "Michael Smith" : "Lily Willaim"} is online and active in this call.`
                  : `🔴 ${formData.student === "stu1" ? "Jane Doe" : formData.student === "stu2" ? "Michael Smith" : "Lily Willaim"} is currently offline.`}
              </p>
            </div>
